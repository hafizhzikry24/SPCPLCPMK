<x-app-layout>
                ...
                <div class="py-12">
                    ...
                    <div class = "border-b border-black ">
                        <div class="p-4 sm:p-8 bg-[#9ADE7B] shadow sm:rounded-lg mb-4">
                            ...
                            <table class="min-w-full mt-4" id="exceldkp">
                                <thead class="border-b-2 border-black">
                                    <tr>
                                        ...
                                        <th class="px-2 py-3 bg-[#F6F1F1] text-center text-xs leading-4 font-medium text-black uppercase tracking-wider">CPL 2</th>
                                        <th class="px-2 py-3 bg-[#F6F1F1] text-center text-xs leading-4 font-medium text-black uppercase tracking-wider">CPL 3</th>
                                        <th class="px-2 py-3 bg-[#F6F1F1] text-center text-xs leading-4 font-medium text-black uppercase tracking-wider">CPL 5</th>
                                        <th class="px-2 py-3 bg-[#F6F1F1] text-center text-xs leading-4 font-medium text-black uppercase tracking-wider">CPL 6</th>
                                        <th class="px-2 py-3 bg-[#F6F1F1] text-center text-xs leading-4 font-medium text-black uppercase tracking-wider">CPL 7</th>
                                        <th class="px-2 py-3 bg-[#F6F1F1] text-center text-xs leading-4 font-medium text-black uppercase tracking-wider">CPL 9</th>
    ...
    <div role="alert" class="container mx-auto w-11/12 md:w-2/3 max-w-lg">
        <div
            ...
            <form action="{{ route('importexceldkp') }}" method="post" enctype="multipart/form-data">
                @csrf
